...
# 编译后镜像输出路径
export HR_IMAGE_DEPLOY_DIR=${HR_TOP_DIR}/deploy_ubuntu_nand_sdcard
...
export HR_BOOT_MODE="nand"
# nand flash page大小，根据nand的属性，可以配置为 "2048" 和 "4096"
export HR_PAGE_SIZE="2048"
# 内核、根文件系统从什么存储介质上加载，可选参数： "emmc", "nand", "sdcard"
export HR_LUNCH_MODE="sdcard"
...
export HR_GPT_CONF_FILENAME="nand_ubuntu_sdcard_gpt.conf"
...
export HR_UBOOT_CONFIG_FILE=xj3_ubuntu_nand_defconfig
# veeprom 和 uboot env 分区的volume配置, 从nand启动时需要使用
export HR_VEEPROM_AND_ENV_CONFIG_FILE=${HR_GPT_CONF_DIR}/nand_ubuntu_ubi_uboot_env.cfg
