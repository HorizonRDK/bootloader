...
# 编译后镜像输出路径
export HR_IMAGE_DEPLOY_DIR=${HR_TOP_DIR}/deploy_ubuntu_sdcard
...
export HR_GPT_CONF_FILENAME="emmc_ubuntu_sdcard_gpt.conf"
...
export HR_UBOOT_CONFIG_FILE=xj3_ubuntu_defconfig
